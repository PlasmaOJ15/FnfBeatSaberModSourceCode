...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'bfsaber':
				var tex = Paths.getSparrowAtlas('beatsaber/BFsaber_assets');
				frames = tex;
				animation.addByPrefix('idle', 'BF idle dance', 24, false);
				animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
				animation.addByPrefix('singLEFT', 'BF NOTE LEFT0', 24, false);
				...
				addOffset('idle', 183, 105);
				addOffset("singUP", -29, 76);
				addOffset("singRIGHT", -38, -7);
				addOffset("singLEFT", 12, -6);
				addOffset("singDOWN", -10, -50);
				addOffset("singUPmiss", -29, 27);
			...
			case 'beatsaber':
				frames = Paths.getSparrowAtlas('beatsaber/bs_assets');
				...
				animation.addByPrefix('swap', 'change', 24, false);

				addOffset('idle');
				addOffset("singUP");
				addOffset("singRIGHT",175);
				addOffset("singLEFT",330);
				addOffset("singDOWN");
				addOffset('swap',0,0);
				playAnim('idle');
				
			case 'rbeatsaber':
				frames = Paths.getSparrowAtlas('beatsaber/bsr_assets');
				
				animation.addByPrefix('idle', 'idle1', 24, false);
				animation.addByPrefix('singUP', 'Up1', 24, false);
				animation.addByPrefix('singLEFT', 'Left1', 24, false);
				animation.addByPrefix('singRIGHT', 'Right1', 24, false);
				animation.addByPrefix('singDOWN', 'Down1', 24, false);
				
				animation.addByPrefix('swap', 'swapsaber', 24, false);

				addOffset('idle');
				addOffset("singUP");
				addOffset("singRIGHT",-1,-23);
				addOffset("singLEFT",330);
				addOffset("singDOWN", -75, -14);
				addOffset('swap',10,-20);
				playAnim('idle');
		}
