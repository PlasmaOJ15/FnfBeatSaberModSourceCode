...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch(SONG.song.toLowerCase())
		{
			...
			case 'beatsaber'|'hundreddollarbills'|'unlimitedpower':
			{
					defaultCamZoom = 0.9;
					curStage = 'bsaber';
					var bg:FlxSprite = new FlxSprite(-600, -300).loadGraphic(Paths.image('beatsaber/bgbsaber'));
					bg.antialiasing = true;
	...
	*/
	...
	override function beatHit()
	{
		...
		if (curSong == 'unlimitedpower')
		{
			switch (curBeat)
			{
				case 247:
					dad.playAnim('swap', true);
				case 252:
					remove(dad);
					dad = new Character(100, 100, 'rbeatsaber');
					add(dad);
			}
		}
